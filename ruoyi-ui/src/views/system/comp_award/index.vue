...
<script>
import { listComp_award, getComp_award, delComp_award, addComp_award, updateComp_award } from "@/api/system/comp_award"
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addComp_award(this.form).then(response => {
