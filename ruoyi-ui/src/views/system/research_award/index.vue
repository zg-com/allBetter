...
<script>
import { listResearch_award, getResearch_award, delResearch_award, addResearch_award, updateResearch_award } from "@/api/system/research_award"
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addResearch_award(this.form).then(response => {
